...
class CastAboutForTest < test_framework
  def setup
    ...
    @tom = User.create(name: 'Tom', introduce: 'I am Tom.', sex: true, profession: 0, sign_in_count: 3, current_sign_in_at: '2016-07-06 16:19:00 +0800', created_at: "2016-07-05 16:19:00 +0800")
    @jack = User.create(name: 'Jack', introduce: 'I am Jack.', sex: true, profession: 2, sign_in_count: 9, current_sign_in_at: '2016-06-09 16:19:00 +0800', created_at: "2016-06-08 16:19:00 +0800")
    @amy = User.create(name: 'Amy', introduce: 'I am Amy.', sex: false, profession: 2, sign_in_count: 1, current_sign_in_at: '2016-07-06 12:10:00 +0800', created_at: "2016-07-05 12:10:00 +0800")
    @tony = User.create(name: 'Tony', introduce: 'I am Tony.', sex: true, profession: 1, sign_in_count: 12, current_sign_in_at: '2015-09-16 13:29:00 +0800', created_at: "2015-09-15 13:29:00 +0800")
    @yasmine = User.create(name: 'Yasmine', introduce: 'I am Yasmine.', sex: false, profession: 3, sign_in_count: 3, current_sign_in_at: '2016-02-16 19:13:00 +0800', created_at: "2016-02-15 19:13:00 +0800")
    @alex = User.create(name: 'Alex', introduce: 'I am Alex.', sex: true, profession: 1, sign_in_count: 53, current_sign_in_at: '2016-07-07 13:09:00 +0800', created_at: "2016-07-06 13:09:00 +0800")
    @james = User.create(name: 'James', introduce: 'I am James.', sex: true, profession: 3, sign_in_count: 3, current_sign_in_at: '2015-07-06 16:19:00 +0800', created_at: "2015-07-05 16:19:00 +0800")
    @kevin = User.create(name: 'Kevin', introduce: 'I am Kevin.', sex: true, profession: 2, sign_in_count: 60, current_sign_in_at: '2016-07-08 23:23:00 +0800', created_at: "2016-07-07 23:23:00 +0800")
    @zita = User.create(name: 'Zita', introduce: 'I am Zita.', sex: false, profession: 0, sign_in_count: 0, current_sign_in_at: '2015-01-01 12:00:00 +0800', created_at: "2014-12-31 12:00:00 +0800")
    @zara = User.create(name: 'Zara', introduce: 'I am Zara.', sex: true, profession: 0, sign_in_count: 10, current_sign_in_at: '2016-04-06 04:03:00 +0800', created_at: "2016-04-05 04:03:00 +0800")
  end
